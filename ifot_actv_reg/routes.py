...
from ifot_actv_reg.forms import TrainForm

SVC_WORKER_IP = '163.221.68.242'
SVC_WORKER_PORT = 5001
CLASSIFY_API_URL = 'api/actv_reg/classify'
TRAIN_API_URL = 'api/actv_reg/train'
TASK_INFO_API_URL = 'api/task/{}/{}'
EXEC_TIME_INFO_API_URL = 'api/get_exec_time/{}'

@app.route('/')
def index():
    return render_template("actv_reg-test.html", form=TrainForm())
